...
const { CriarPoolGlobal } = require('./utils/Database');
const bodyParser = require('body-parser');

const App = Express(); /* Inicializar o Express */
const Port = 8080; /* Porta do servidor */

App.use(bodyParser.json({ type: 'application/json' })); /* Converte o body em JSON */

async function inicializar() {
    await CriarPoolGlobal(); /* Inicializa uma pool no banco de dados */
